...
Twitter has a strong level of support for Initiatie 1631, but the voting results are very different. Below is a chart that displays the overall sum of votes for Yes and No.
```{r}
